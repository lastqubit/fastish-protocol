...
// @dev Use `withdraw` for externally delivered assets; use `creditTo` for internal balance credits.
abstract contract Withdraw is CommandBase {
    uint internal immutable withdrawId = toCommandId(NAME, address(this));
