...
import { BlockPair, Block, Listing, AssetAmount, HostAmount, Tx, Keys } from "./Schema.sol";
...
library Blocks {
    ...
    function toListingValue(Block memory ref) internal pure returns (Listing memory value) {
        ensure(ref, Keys.LISTING, 96);
